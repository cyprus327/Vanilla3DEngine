    ...
    public struct Mesh {
        ...
        public Vector3 GetCenter() {
            ...
            foreach (Triangle tri in Tris) {
                count++;
                foreach (Vector3 v in tri.Verts) {
                    output.X += v.X;
                    output.Y += v.Y;
                    output.Z += v.Z;
                }
        ...
        public static Mesh LoadFromOBJFile(string filename) {
            Mesh mesh = new Mesh() { Tris = new List<Triangle>() };
            ...
            while (!stream.EndOfStream) {
                ...
                if (line[0] == 'v') {
                    ...
                    if (verts[f[0] - 1] != null && verts[f[1] - 1] != null && verts[f[2] - 1] != null)
                        mesh.Tris.Add(new Triangle() { Verts = new Vector3[3] { verts[f[0] - 1], verts[f[1] - 1], verts[f[2] - 1] } });
                }
            }
        ...
        public static Mesh Plane => new Mesh {
            Tris = new List<Triangle> {
                ...
                new Triangle() { Verts = new Vector3[3] { new Vector3(1f, 0f, 1f), new Vector3(0f, 0f, 1f), new Vector3(0f, 0f, 0f) } },
                new Triangle() { Verts = new Vector3[3] { new Vector3(1f, 0f, 1f), new Vector3(0f, 0f, 0f), new Vector3(1f, 0f, 0f) } }
            },
        };
